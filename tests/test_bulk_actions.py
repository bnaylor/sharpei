...
def test_bulk_priority_change(ui_page):
    ...
    # Use evaluate to click the dropdown item directly if standard click fails
    ui_page.evaluate("""
        const dropdownItem = Array.from(document.querySelectorAll('.bulk-action-bar .dropdown-item'))
